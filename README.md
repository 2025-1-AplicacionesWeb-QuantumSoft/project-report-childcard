...
| _Prepared by_                  | Walter Fajardo                                                                                                                                                                                                                                                                                                                                                        |
| _Attendees (planning meeting)_ | Walter Fajardo, Lynn Meza, Jorge Linares, Joaquin Cuentas                                                                                                                                                                                                                                                                                                             |
| _Sprint 3-1 Review - Summary_  | Durante el Sprint 4, se logró desarrollar una versión operativa de la Web App, con todos los componentes esenciales implementados y funcionando de acuerdo a lo esperado.                                                                                                                                                                                             |
| _Sprint 3-1 Retrospective_     | En el Sprint 4, se desarrollaron correctamente los endpoints funcionales de cada bounded context, asegurando su integración adecuada y su funcionamiento según los requerimientos establecidos.                                                                                                                                                                       |
...
En este Sprint 4, se ha trabajado en la documentación de los Web Services relacionados con todos los enspoind dentro de la plataforma KidyCare. A continuación, se detallan los Endpoints documentados y las acciones implementadas . Además, se incluirán capturas de pantalla de la interacción con estos servicios y el enlace al repositorio con los commits correspondientes.

### Card

| **Endpoint**                         | **Acción**                          | **Verbo HTTP** | **Sintaxis de Llamada**                                          | **Parámetros**                                    | **Ejemplo de Respuesta**                                                                                         | **Explicación del Response**                                                                                                                                          |
|--------------------------------------|-------------------------------------|----------------|------------------------------------------------------------------|--------------------------------------------------|------------------------------------------------------------------------------------------------------------------|--------------------------------------------------------------------------------------------------------------------------------------------------------------------|
| `/api/v1/cards/{cardId}`             | Obtener una tarjeta por ID          | GET            | `GET /api/v1/cards/{cardId}`                                     | `cardId` (ID de la tarjeta)                      | `{"id": 1, "name": "Card1", "balance": 100, "status": "Active"}`                                                   | Devuelve los detalles de la tarjeta solicitada con su nombre, balance y estado.                                                                                   |
| `/api/v1/cards`                      | Obtener todas las tarjetas          | GET            | `GET /api/v1/cards`                                              | Ninguno                                           | `[{"id": 1, "name": "Card1", "balance": 100, "status": "Active"}, {"id": 2, "name": "Card2", "balance": 50, "status": "Inactive"}]` | Devuelve una lista de todas las tarjetas disponibles en la plataforma.                                                                                             |
| `/api/v1/cards`                      | Crear una nueva tarjeta             | POST           | `POST /api/v1/cards`                                             | `name`, `balance`, `status`                       | `{"id": 3, "name": "New Card", "balance": 200, "status": "Active"}`                                                | Crea una nueva tarjeta con los parámetros proporcionados y devuelve los detalles de la nueva tarjeta.                                                               |
| `/api/v1/cards/parent/{parentId}`    | Obtener tarjetas de un padre        | GET            | `GET /api/v1/cards/parent/{parentId}`                             | `parentId` (ID del padre)                         | `[{"id": 1, "name": "Parent Card 1", "balance": 150, "status": "Active"}]`                                          | Devuelve las tarjetas asociadas al padre con el ID proporcionado.                                                                                               |
| `/api/v1/cards/babysitter/{babysitterId}` | Obtener tarjetas de una niñera     | GET            | `GET /api/v1/cards/babysitter/{babysitterId}`                    | `babysitterId` (ID de la niñera)                  | `[{"id": 2, "name": "Babysitter Card 1", "balance": 100, "status": "Active"}]`                                    | Devuelve las tarjetas asociadas a la niñera con el ID proporcionado.                                                                                             |
| `/api/v1/cards/{id}`                 | Actualizar una tarjeta por ID       | PUT            | `PUT /api/v1/cards/{id}`                                         | `id` (ID de la tarjeta), `name`, `balance`, `status` | `{"id": 1, "name": "Updated Card", "balance": 150, "status": "Active"}`                                            | Actualiza los detalles de la tarjeta especificada por su ID y devuelve la tarjeta actualizada.                                                                      |
| `/api/v1/cards/{id}`                 | Eliminar una tarjeta por ID         | DELETE         | `DELETE /api/v1/cards/{id}`                                      | `id` (ID de la tarjeta)                          | `{"message": "Card deleted successfully"}`                                                                       | Elimina la tarjeta especificada por su ID y devuelve un mensaje de éxito.                                                                                         |

![Cards-endpoint](./assets/cards-endpoint.png)

### Payments

| **Endpoint**                         | **Acción**                          | **Verbo HTTP** | **Sintaxis de Llamada**                                          | **Parámetros**                                    | **Ejemplo de Respuesta**                                                                                         | **Explicación del Response**                                                                                                                                          |
|--------------------------------------|-------------------------------------|----------------|------------------------------------------------------------------|--------------------------------------------------|------------------------------------------------------------------------------------------------------------------|--------------------------------------------------------------------------------------------------------------------------------------------------------------------|
| `/api/v1/payments`                  | Obtener todos los pagos             | GET            | `GET /api/v1/payments`                                           | Ninguno                                           | `[{"id": 1, "amount": 100, "status": "Completed", "date": "2025-07-09"}]`                                          | Devuelve una lista con todos los pagos realizados en la plataforma.                                                                                               |
| `/api/v1/payments`                  | Crear un nuevo pago                 | POST           | `POST /api/v1/payments`                                          | `amount`, `status`, `date`                        | `{"id": 2, "amount": 200, "status": "Pending", "date": "2025-07-09"}`                                                | Crea un nuevo pago con los parámetros proporcionados y devuelve los detalles del pago recién creado.                                                               |
| `/api/v1/payments/byparent/{parentId}` | Obtener pagos por ID de padre       | GET            | `GET /api/v1/payments/byparent/{parentId}`                        | `parentId` (ID del padre)                         | `[{"id": 1, "amount": 100, "status": "Completed", "date": "2025-07-09"}]`                                          | Devuelve una lista de pagos realizados por el padre con el ID proporcionado.                                                                                       |
| `/api/v1/payments/{paymentId}`       | Obtener pago por ID de pago         | GET            | `GET /api/v1/payments/{paymentId}`                                | `paymentId` (ID del pago)                         | `{"id": 1, "amount": 100, "status": "Completed", "date": "2025-07-09"}`                                            | Devuelve los detalles de un pago específico identificado por su ID.                                                                                               |

![Payments-Endpoint](./assets/payments-endpoint.png)

### Authentication

| **Endpoint**                         | **Acción**                          | **Verbo HTTP** | **Sintaxis de Llamada**                                          | **Parámetros**                                    | **Ejemplo de Respuesta**                                                                                         | **Explicación del Response**                                                                                                                                          |
|--------------------------------------|-------------------------------------|----------------|------------------------------------------------------------------|--------------------------------------------------|------------------------------------------------------------------------------------------------------------------|--------------------------------------------------------------------------------------------------------------------------------------------------------------------|
| `/api/v1/authentication/sign-in`     | Iniciar sesión                      | POST           | `POST /api/v1/authentication/sign-in`                             | `email`, `password`                               | `{"message": "Login successful", "token": "jwt.token.here"}`                                                      | Autentica al usuario con las credenciales proporcionadas y devuelve un token JWT si la autenticación es exitosa.                                                   |
| `/api/v1/authentication/sign-up`     | Registrarse                          | POST           | `POST /api/v1/authentication/sign-up`                             | `name`, `email`, `password`                       | `{"message": "User registered successfully", "userId": 1}`                                                       | Registra un nuevo usuario con los parámetros proporcionados y devuelve un mensaje de éxito junto con el ID del usuario creado.                                       |

![Authentication-Endpoint](./assets/authentication-endpoint.png)

### Users

| **Endpoint**                         | **Acción**                          | **Verbo HTTP** | **Sintaxis de Llamada**                                          | **Parámetros**                                    | **Ejemplo de Respuesta**                                                                                         | **Explicación del Response**                                                                                                                                          |
|--------------------------------------|-------------------------------------|----------------|------------------------------------------------------------------|--------------------------------------------------|------------------------------------------------------------------------------------------------------------------|--------------------------------------------------------------------------------------------------------------------------------------------------------------------|
| `/api/v1/users/{id}`                | Obtener un usuario por ID           | GET            | `GET /api/v1/users/{id}`                                         | `id` (ID del usuario)                             | `{"id": 1, "name": "John Doe", "email": "john.doe@example.com", "role": "parent"}`                               | Devuelve los detalles del usuario identificado por su ID.                                                                                                         |
| `/api/v1/users`                     | Obtener todos los usuarios         | GET            | `GET /api/v1/users`                                              | Ninguno                                           | `[{"id": 1, "name": "John Doe", "email": "john.doe@example.com", "role": "parent"}, {"id": 2, "name": "Jane Doe", "email": "jane.doe@example.com", "role": "babysitter"}]` | Devuelve una lista con todos los usuarios registrados en la plataforma.                                                                                             |

![Users](./assets/users-endpoint.png)

### Babysitter

| **Endpoint**                         | **Acción**                          | **Verbo HTTP** | **Sintaxis de Llamada**                                          | **Parámetros**                                    | **Ejemplo de Respuesta**                                                                                         | **Explicación del Response**                                                                                                                                          |
|--------------------------------------|-------------------------------------|----------------|------------------------------------------------------------------|--------------------------------------------------|------------------------------------------------------------------------------------------------------------------|--------------------------------------------------------------------------------------------------------------------------------------------------------------------|
| `/api/v1/babysitter`                | Crear una niñera                    | POST           | `POST /api/v1/babysitter`                                        | `name`, `userId`, `experience`, `availability`     | `{"id": 1, "name": "Jane Doe", "userId": 5, "experience": "2 years", "availability": "Weekdays"}`                 | Crea una nueva niñera con los parámetros proporcionados y devuelve los detalles de la niñera recién creada.                                                           |
| `/api/v1/babysitter`                | Obtener todas las niñeras           | GET            | `GET /api/v1/babysitter`                                         | Ninguno                                           | `[{"id": 1, "name": "Jane Doe", "userId": 5, "experience": "2 years", "availability": "Weekdays"}]`              | Devuelve una lista con todas las niñeras registradas en la plataforma.                                                                                             |
| `/api/v1/babysitter/user/{userId}`  | Obtener niñera por ID de usuario    | GET            | `GET /api/v1/babysitter/user/{userId}`                            | `userId` (ID del usuario)                         | `{"id": 1, "name": "Jane Doe", "userId": 5, "experience": "2 years", "availability": "Weekdays"}`                 | Devuelve los detalles de la niñera asociada al usuario con el ID proporcionado.                                                                                     |
| `/api/v1/babysitter/{id}`           | Obtener niñera por ID               | GET            | `GET /api/v1/babysitter/{id}`                                    | `id` (ID de la niñera)                             | `{"id": 1, "name": "Jane Doe", "userId": 5, "experience": "2 years", "availability": "Weekdays"}`                 | Devuelve los detalles de la niñera identificada por su ID.                                                                                                         |
| `/api/v1/babysitter/{id}`           | Actualizar niñera por ID            | PATCH          | `PATCH /api/v1/babysitter/{id}`                                  | `id` (ID de la niñera), `name`, `experience`, `availability` | `{"id": 1, "name": "Jane Smith", "userId": 5, "experience": "3 years", "availability": "Weekends"}`               | Actualiza los detalles de la niñera especificada por su ID y devuelve la niñera actualizada.                                                                       |

![Babysitter](./assets/babysitter-endpoint.png)

### Parent

| **Endpoint**                         | **Acción**                          | **Verbo HTTP** | **Sintaxis de Llamada**                                          | **Parámetros**                                    | **Ejemplo de Respuesta**                                                                                         | **Explicación del Response**                                                                                                                                          |
|--------------------------------------|-------------------------------------|----------------|------------------------------------------------------------------|--------------------------------------------------|------------------------------------------------------------------------------------------------------------------|--------------------------------------------------------------------------------------------------------------------------------------------------------------------|
| `/api/v1/parent`                    | Crear un padre                      | POST           | `POST /api/v1/parent`                                            | `name`, `userId`, `childrenCount`                  | `{"id": 1, "name": "John Doe", "userId": 2, "childrenCount": 3}`                                                   | Crea un nuevo padre con los parámetros proporcionados y devuelve los detalles del padre recién creado.                                                             |
| `/api/v1/parent/{id}`               | Obtener un padre por ID             | GET            | `GET /api/v1/parent/{id}`                                         | `id` (ID del padre)                                 | `{"id": 1, "name": "John Doe", "userId": 2, "childrenCount": 3}`                                                   | Devuelve los detalles del padre identificado por su ID.                                                                                                           |
| `/api/v1/parent/{id}`               | Actualizar un padre por ID          | PATCH          | `PATCH /api/v1/parent/{id}`                                       | `id` (ID del padre), `name`, `childrenCount`       | `{"id": 1, "name": "John Smith", "userId": 2, "childrenCount": 4}`                                                 | Actualiza los detalles del padre especificado por su ID y devuelve el padre actualizado.                                                                           |
| `/api/v1/parent/user/{userId}`      | Obtener un padre por ID de usuario  | GET            | `GET /api/v1/parent/user/{userId}`                                | `userId` (ID del usuario)                           | `{"id": 1, "name": "John Doe", "userId": 2, "childrenCount": 3}`                                                   | Devuelve los detalles del padre asociado al usuario con el ID proporcionado.                                                                                       |

![parent](./assets/parent-endpoint.png)

### Reservation

| **Endpoint**                         | **Acción**                          | **Verbo HTTP** | **Sintaxis de Llamada**                                          | **Parámetros**                                    | **Ejemplo de Respuesta**                                                                                         | **Explicación del Response**                                                                                                                                          |
|--------------------------------------|-------------------------------------|----------------|------------------------------------------------------------------|--------------------------------------------------|------------------------------------------------------------------------------------------------------------------|--------------------------------------------------------------------------------------------------------------------------------------------------------------------|
| `/api/v1/reservation`               | Crear una reserva                   | POST           | `POST /api/v1/reservation`                                       | `babysitterId`, `parentId`, `date`, `time`        | `{"id": 1, "babysitterId": 2, "parentId": 1, "date": "2025-07-09", "time": "10:00 AM"}`                            | Crea una nueva reserva con los parámetros proporcionados y devuelve los detalles de la reserva recién creada.                                                          |
| `/api/v1/reservation/{id}`          | Obtener una reserva por ID          | GET            | `GET /api/v1/reservation/{id}`                                    | `id` (ID de la reserva)                           | `{"id": 1, "babysitterId": 2, "parentId": 1, "date": "2025-07-09", "time": "10:00 AM"}`                            | Devuelve los detalles de la reserva identificada por su ID.                                                                                                        |
| `/api/v1/reservation/{id}`          | Actualizar una reserva por ID       | PUT            | `PUT /api/v1/reservation/{id}`                                    | `id` (ID de la reserva), `date`, `time`           | `{"id": 1, "babysitterId": 2, "parentId": 1, "date": "2025-07-10", "time": "11:00 AM"}`                            | Actualiza los detalles de la reserva especificada por su ID y devuelve la reserva actualizada.                                                                     |
| `/api/v1/reservation/{id}`          | Eliminar una reserva por ID         | DELETE         | `DELETE /api/v1/reservation/{id}`                                 | `id` (ID de la reserva)                           | `{"message": "Reservation deleted successfully"}`                                                                | Elimina la reserva especificada por su ID y devuelve un mensaje de éxito.                                                                                          |
| `/api/v1/reservation/babysitter/{babysitterId}` | Obtener todas las reservas por ID de niñera | GET            | `GET /api/v1/reservation/babysitter/{babysitterId}`               | `babysitterId` (ID de la niñera)                  | `[{"id": 1, "babysitterId": 2, "parentId": 1, "date": "2025-07-09", "time": "10:00 AM"}]`                         | Devuelve todas las reservas asociadas a la niñera con el ID proporcionado.                                                                                         |
| `/api/v1/reservation/parent/{parentId}` | Obtener todas las reservas por ID de padre | GET            | `GET /api/v1/reservation/parent/{parentId}`                       | `parentId` (ID del padre)                         | `[{"id": 1, "babysitterId": 2, "parentId": 1, "date": "2025-07-09", "time": "10:00 AM"}]`                         | Devuelve todas las reservas asociadas al padre con el ID proporcionado.                                                                                           |

![Reservation](./assets/reservation-enpoints.png)

### Review

| **Endpoint**                         | **Acción**                          | **Verbo HTTP** | **Sintaxis de Llamada**                                          | **Parámetros**                                    | **Ejemplo de Respuesta**                                                                                         | **Explicación del Response**                                                                                                                                          |
|--------------------------------------|-------------------------------------|----------------|------------------------------------------------------------------|--------------------------------------------------|------------------------------------------------------------------------------------------------------------------|--------------------------------------------------------------------------------------------------------------------------------------------------------------------|
| `/api/v1/review`                    | Crear una reseña                    | POST           | `POST /api/v1/review`                                            | `userId`, `babysitterId`, `rating`, `comment`     | `{"id": 1, "userId": 2, "babysitterId": 3, "rating": 5, "comment": "Excellent service!"}`                        | Crea una nueva reseña con los parámetros proporcionados y devuelve los detalles de la reseña recién creada.                                                           |
| `/api/v1/review`                    | Consultar reseñas por parámetros    | GET            | `GET /api/v1/review`                                             | `userId`, `babysitterId`, `rating`                | `[{"id": 1, "userId": 2, "babysitterId": 3, "rating": 5, "comment": "Excellent service!"}]`                      | Devuelve una lista de reseñas basadas en los parámetros proporcionados.                                                                                             |
| `/api/v1/review/{id}`               | Obtener una reseña por ID           | GET            | `GET /api/v1/review/{id}`                                        | `id` (ID de la reseña)                             | `{"id": 1, "userId": 2, "babysitterId": 3, "rating": 5, "comment": "Excellent service!"}`                        | Devuelve los detalles de la reseña identificada por su ID.                                                                                                         |
| `/api/v1/review/{id}`               | Actualizar una reseña por ID        | PUT            | `PUT /api/v1/review/{id}`                                        | `id` (ID de la reseña), `rating`, `comment`        | `{"id": 1, "userId": 2, "babysitterId": 3, "rating": 4, "comment": "Good service!"}`                             | Actualiza los detalles de la reseña especificada por su ID y devuelve la reseña actualizada.                                                                       |
| `/api/v1/review/{id}`               | Eliminar una reseña por ID          | DELETE         | `DELETE /api/v1/review/{id}`                                     | `id` (ID de la reseña)                             | `{"message": "Review deleted successfully"}`                                                                     | Elimina la reseña especificada por su ID y devuelve un mensaje de éxito.                                                                                           |

![Review](./assets/Review-endpoint.jpg)
